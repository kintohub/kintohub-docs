...
Beego is an open-source, high-performance web framework for the Go programming language. It can be built easily for microservice on KintoHub!

[Live Example](https://8caf94bb-c2e5-45cf-898d-ca5b19954cda.api.master.kintohub.com/beego-example/hello/world)

## Deployment
1. Apply this template to your [Github](https://github.com/kintohub/beego-example/generate)
...
Try this [Live Example](https://8caf94bb-c2e5-45cf-898d-ca5b19954cda.api.master.kintohub.com/beego-example/hello/world) !
